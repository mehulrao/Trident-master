...
t_target_environment info_to_target_environment(const char *device_model, const char *system_version) {
    ...
    determineTarget("iPhone4,1", "9.3.5", iPhone41_iOS935);
...
uint32_t find_OSSerializer_serialize(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0x318388;
...
uint32_t find_OSSymbol_getMetaClass(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0x31ab90;
...
uint32_t find_calend_gettime(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0x1e200;
...
uint32_t find_bufattr_cpx(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0xd9838;
...
uint32_t find_clock_ops(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0x403428;
...
uint32_t find_copyin(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0xc76b4;
...
uint32_t find_bx_lr(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0xd983a;
...
uint32_t find_write_gadget(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0xc73e8;
...
uint32_t find_vm_kernel_addrperm(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0x455844;
...
uint32_t find_kernel_pmap(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0x3f6454;
...
uint32_t find_flush_dcache(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0xbc1d4;
...
uint32_t find_invalidate_tlb(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0xc7440;
...
uint32_t find_task_for_pid(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0x2fcec0;
...
uint32_t find_setreuid(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0x2a9988;
...
uint32_t find_pid_check(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0x14;
...
uint32_t find_posix_check(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0x3e;
...
uint32_t find_mac_proc_check(void) {
	switch (target_environment) {
        ...
        case iPhone41_iOS935: return 0x1e6;
